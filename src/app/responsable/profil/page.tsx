...
export default async function ResponsableProfilPage() {
  ...
  return (
    <div>
      <SubpageHeader title="Mon profil" backHref="/responsable/apercu" />
      <div className="px-6">
        <div className="bg-card rounded-lg2 shadow-card p-[22px] flex flex-col gap-3.5">
          <div className="flex items-center gap-3.5">
            ...
            <div>
              ...
              <div className="text-faint text-[13.5px] mt-0.5">Équipe Responsable</div>
            </div>
          </div>
        ...
        <SpaceSwitcher roles={(roles?.map((r) => r.role) as AppRole[]) ?? []} current="responsable" />
